...
#
#              for k in range(r - s):   r and s are undefined
#                  count = 0            needs ==
#                  if math.cos(r) > 0:    needs import math
#                      count = 1          needs ==
#                  return count          return to where
#
#     f. The code in the "graphics accumulation" example below includes:
#            for _ in range(n):
#        What does the   _   (underscore) mean?  an undetermined variable
#
